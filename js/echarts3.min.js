! function (t, e) {
    ...
    return function (t) {
            ...
            D(O, function (e) {
                t.on(e, function (t) {
                    ...
                    if (n && null != n.dataIndex) {
                        var o = n.hostModel || i.getSeriesByIndex(n.seriesIndex)
                            , a = o && o.getDataParams(n.dataIndex) || {};
        ...
        function d(t, e, i, n, o) {
            var a = t ? "Update" : ""
                , r = n && n.getShallow("animationDuration" + a)
        ...
        }), s.enableSubTypeDefaulter(u), s.enableTopologicalTravel(u, n), a.mixin(u, i(116)), t.exports = u
    }, function (t, e, i) {
        "use strict";
            ...
            if (n(c) && n(d))
                ...
                if (n(m)) {
                    ...
                    var I = (2 * c * l - 3 * s * d) / (2 * w(c * c * c))
                        ...
                        , L = Math.cos(T)
                        , g = (-l - 2 * C * L) / (3 * s)
                        , y = (-l + C * (L + M * Math.sin(T))) / (3 * s)
                        , D = (-l + C * (L - M * Math.sin(T))) / (3 * s);
        ...
        function g(t, e, n) {
            if (e && e.length && t >= 0 && 1 >= t) {
                var a = t * (e.length - 1)
                    ...
                    , c = h(e[s])
                    , d = a - r
                    , f = x([i(l(u[0], c[0], d)), i(l(u[1], c[1], d)), i(l(u[2], c[2], d)), o(l(u[3], c[3], d))], "rgba");
                return n ? {
                    color: f
                    , leftIndex: r
                    , rightIndex: s
        ...
        u._createSymbol = function (t, e, i) {
            ...
            l.initProps(h, {
                scale: u
            }, o), this._symbolType = t, this.add(h)
        ...
        u._updateCommon = function (t, e, i) {
            ...
            for (var x, _ = s.getModel(f), w = s.getModel(p), b = o.style, M = t.dimensions.slice(), S = M.pop();
        ...
        var f = {
                ...
                , axisTick: function () {
                    ...
                    if (t.get("axisTick.show")) {
                        for (var e = t.axis, i = t.getModel("axisTick"), n = this.opt, o = i.getModel("lineStyle"), a = i.get("length"), s = g(i, n.labelInterval), l = e.getTicksCoords(), h = [], u = 0; u < l.length; u++)
                            if (!p(e, u, s)) {
                                var c = l[u];
            ...
            if (x) {
                ...
                if (!L) {
                    ...
                    var W = function (t, e) {
                            ...
                            if (0 !== n)
                                if (E = (e - I[i]) / n, v)
                                    if (V = T[i], O = T[0 === i ? i : i - 1], N = T[i > x - 2 ? x - 1 : i + 1], B = T[i > x - 3 ? x - 1 : i + 2], b) u(O, V, N, B, E, E * E, E * E * E, d(t, o), A);
                                    else {
                                        var l;
                                        if (M) l = u(O, V, N, B, E, E * E, E * E * E, H, 1), l = f(H);
                                        else {
                                            if (S) return r(V, N, E);
                            ...
                            else if (b) s(T[i], T[i + 1], E, d(t, o), A);
                            else {
                                var l;
                                if (M) s(T[i], T[i + 1], E, H, 1), l = f(H);
                                else {
        ...
        r.prototype = {
            ...
            , getBoundingRect: function () {
                if (!this._rect) {
                    var t = this.style
                        , e = a.getBoundingRect(t.text + "", t.textFont || t.font, t.textAlign, t.textBaseline);
            ...
            , drawRectText: function (t, e, i) {
                ...
                if (null != l && (l += ""), l) {
                    ...
                    var v = this.transform
                        , y = this.invTransform;
                    if (v && (s.copy(e), s.applyTransform(v), e = s, o(t, y)), c instanceof Array) h = e.x + n(c[0], e.width), u = e.y + n(c[1], e.height), f = f || "left", g = g || "top";
                    else {
        ...
        function r(t) {
            return {
                applyVisual: function (e, i, n) {
                    var o = i("color")
                        , a = c.isArray(e);
                    if (e = a ? [this.mapValueToVisual(e[0]), this.mapValueToVisual(e[1])] : this.mapValueToVisual(e), c.isArray(o))
                        for (var r = 0, s = o.length; s > r; r++) o[r].color = t(o[r].color, a ? e[r] : e);
                    else n("color", t(o, e))
                }
                , mapValueToVisual: function (t) {
                    var e = this._normalizeData(t)
                        , i = this._getSpecifiedVisual(t)
                        , o = this.option.visual;
        ...
        o.extend(i(12).prototype, i(82)), t.exports = i(2).extendChartView({
            ...
            , _renderOnCartesian: function (t, e, i) {
                ...
                l.diff(h).add(function (t) {
                    ...
                    n(u, c), a.updateProps(o, {
                        shape: u
                    }, t), l.setItemGraphicEl(e, o), s.add(o)
                }).remove(function (e) {
            ...
            , _updateStyle: function (t, e, i) {
                ...
                e.eachItemGraphicEl(function (r, s) {
                    ...
                    r.setShape("r", c.get("barBorderRadius") || 0), r.setStyle(o.defaults({
                        fill: h
                    }, c.getBarItemStyle()));
        ...
        function n(t, e, i) {
            var n = e.getItemVisual(i, "color")
                , o = e.getItemVisual(i, "symbol")
                , a = e.getItemVisual(i, "symbolSize");
            if ("none" !== o) {
                p.isArray(a) || (a = [a, a]);
        ...
        m.beforeUpdate = s, m._createLine = function (t, e, i, a) {
            ...
            var o = t.hostModel
                ...
                , c = g.round(o.getRawValue(n));
            isNaN(c) && (c = t.getName(n)), a.setStyle(p.extend({
        ...
        t.exports = y.extend({
            ...
            , render: function (t, e, i) {
                ...
                A && A.eachItemGraphicEl(function (t, e) {
                    ...
                    t.stopAnimation(!0)
                }), n(this._stackedOnPoints, b) && n(this._points, f) || (_ ? this._updateAnimation(l, b, a, i) : (v.setShape({
                    points: f
                }), y && y.setShape({
                    points: f
                    , stackedOnPoints: b
        ...
        function n(t, e, i, n, o, a, p, g, m, v) {
            for (var y = i, x = 0; o > x; x++) {
                ...
                if (y === i) t[a > 0 ? "moveTo" : "lineTo"](_[0], _[1]), u(d, _);
                else if (m > 0) {
                    var w = y - a
                        , b = y + a
                        , M = .5
                        , S = e[w]
                        , A = e[b];
                    if (a > 0 && (y === o - 1 || isNaN(A[0]) || isNaN(A[1])) || 0 >= a && (0 === y || isNaN(A[0]) || isNaN(A[1]))) u(f, _);
                    else {
                ...
                for (var r = a > 0 ? e ? Number.MAX_VALUE : 0 : e ? Number.MAX_VALUE : 0, s = 0, l = t.length; l > s; s++)
                    if ("center" !== t[s].position) {
                        var h = Math.abs(t[s].y - n)
                            , u = t[s].length
                            , c = o + u > h ? Math.sqrt((o + u + 20) * (o + u + 20) - Math.pow(t[s].y - n, 2)) : Math.abs(t[s].x - i);
        ...
        n.prototype = {
            ...
            , setOption: function (t, e) {
                ...
                var i = this._optionBackup
                    , n = this._newOptionBackup = o.call(this, t, e);
        ...
        function n(t) {
            ...
            e && o.each(a, function (i) {
                var n = e.normal
                    , a = e.emphasis;
                n && n[i] && (t[i] = t[i] || {}, t[i].normal ? o.merge(t[i].normal, n[i]) : t[i].normal = n[i], n[i] = null), a && a[i] && (t[i] = t[i] || {}, t[i].emphasis ? o.merge(t[i].emphasis, a[i]) : t[i].emphasis = a[i], a[i] = null)
            })
        }
        var o = i(1)
        ...
        function n(t, e, i, n, o, a, r, s, l, h, u) {
            var g = l * (p / 180)
                ...
                , _ = y * y / (r * r) + x * x / (s * s);
            _ > 1 && (r *= c(_), s *= c(_));
            var w = (o === a ? -1 : 1) * c((r * r * (s * s) - r * r * (x * x) - s * s * (y * y)) / (r * r * (x * x) + s * s * (y * y))) || 0
                , b = w * r * x / s
                , M = w * -s * y / r
                , S = (t + i) / 2 + f(g) * b - d(g) * M
                , A = (e + n) / 2 + d(g) * b + f(g) * M
        ...
        function o(t, e, i) {
            ...
            var s = new r(o, i)
                , l = new r(o, i)
                , h = new r([], i)
                , u = a.map(i.get("data"), a.curry(p, e, t, i));
        ...
        a.defaults(g, l.dataFormatMixin), i(2).extendComponentView({
            ...
            , _renderSeriesML: function (t, e, i, n) {
                ...
                a.isArray(x) || (x = [x, x]), "number" == typeof _ && (_ = [_, _]), p.from.each(function (t) {
                    ...
                    }), y.setItemLayout(t, [m.getItemLayout(t), v.getItemLayout(t)])
        ...
        function n(t, e, i) {
            ...
            var o = new c(n, i)
                , r = a.map(i.get("data"), a.curry(d.dataTransform, e));
        ...
        var o = i(38)
            ...
            , f = {
                ...
                , formatTooltip: function (t) {
                    var e = this.getData()
                        , i = this.getRawValue(t)
                        , n = a.isArray(i) ? a.map(i, h).join(", ") : h(i)
                        , o = e.getName(t);
        ...
        a.defaults(f, s.dataFormatMixin), i(2).extendComponentView({
            ...
            , _renderSeriesMP: function (t, e, i) {
                ...
                a.mixin(e, f), e.setData(d), d.each(function (n) {
                    var o, a = d.getItemModel(n)
                        , s = a.getShallow("x")
                        , u = a.getShallow("y");
                    if (null != s && null != u) o = [l.parsePercent(s, i.getWidth()), l.parsePercent(u, i.getHeight())];
                    else if (t.getMarkerPosition) o = t.getMarkerPosition(d.getValues(d.dimensions, n));
                    else if (r) {
                        var c = d.get(p[0], n)
                            , f = d.get(p[1], n);
                        o = r.dataToPoint([c, f])
        ...
        function h(t, e, i, n, o, a, r) {
            ...
            if (a && c.applyTransform(a.transform), "function" == typeof t && (t = t([e, i], o, c)), f.isArray(t)) e = m(t[0], h), i = m(t[1], u);
            ...
            , _tryShow: function (t) {
                ...
                if (i)
                    if (this._lastX = t.offsetX, this._lastY = t.offsetY, e && null != e.dataIndex) {
                        var r = e.tooltipFormatModel || o.getSeriesByIndex(e.seriesIndex)
                            , s = e.dataIndex
        ...
        s.updateData = function (t, e, i) {
            ...
            n.setStyle(r.defaults({
                fill: d
            }, c.getModel("normal").getItemStyle())), n.hoverStyle = c.getModel("emphasis").getItemStyle(), this._updateLabel(t, e), a.setHoverStyle(this)
        ...
        function a(t) {
            t.each(function (e) {
                ...
                if (d) n = (c[0][0] + c[1][0] + c[2][0] + c[3][0]) / 4, o = (c[0][1] + c[1][1] + c[2][1] + c[3][1]) / 4, i = "center", a = [[n, o], [n, o]];
                else {
            ...
            , u = i(25).extend({
                ...
                , _renderMain: function (t, e, i, n, o) {
                    for (var a = this.group, s = t.getModel("axisLine"), l = s.getModel("lineStyle"), u = t.get("clockwise"), c = -t.get("startAngle") / 180 * Math.PI, d = -t.get("endAngle") / 180 * Math.PI, f = (d - c) % h, p = c, g = l.get("width"), m = 0; m < n.length; m++) {
                        ...
                        v.setStyle({
                            fill: n[m][1]
                        }), v.setStyle(l.getLineStyle(["color", "borderWidth", "borderColor"])), a.add(v), p = d
                    }
                    var y = function (t) {
                        if (0 >= t) return n[0][1];
                ...
                , _renderTicks: function (t, e, i, n, a, h, u, c) {
                    for (var d = this.group, f = a.cx, p = a.cy, g = a.r, m = t.get("min"), v = t.get("max"), y = t.getModel("splitLine"), x = t.getModel("axisTick"), _ = t.getModel("axisLabel"), w = t.get("splitNumber"), b = x.get("splitNumber"), M = l(y.get("length"), g), S = l(x.get("length"), g), A = h, I = (u - h) / w, T = I / b, C = y.getModel("lineStyle").getLineStyle(), L = x.getModel("lineStyle").getLineStyle(), D = _.getModel("textStyle"), P = 0; w >= P; P++) {
                        ...
                        if (_.get("show")) {
                            var E = o(s.round(P / w * (v - m) + m), _.get("formatter"))
                                , O = new r.Text({
                                    style: {
                                        text: E
                                        , x: k * (g - M - 5) + f
        ...
        var n = i(2)
            , o = i(1);
        i(247), i(248), i(255), n.registerProcessor("filter", i(249)), n.registerVisualCoding("chart", o.curry(i(44), "graph", "circle", null)), n.registerVisualCoding("chart", i(250)), n.registerLayout(i(256)), n.registerLayout(i(251)), n.registerLayout(i(254)), n.registerCoordinateSystem("graphView", {
            create: i(252)
        })
    }, function (t, e, i) {
        "use strict";
            ...
            , render: function (t, e, i) {
                ...
                if ("geo" === n.type || "view" === n.type) {
                    ...
                    var a = this._symbolDraw
                        , l = this._lineDraw;
                    a.updateData(o);
                    var h = o.graph.edgeData
                        , u = t.option
                        , c = r.createDataFormatModel(t, h, u.edges || u.links);
                    c.formatTooltip = function (t) {
                        var e = this.getDataParams(t)
                            , i = o.graph.getEdgeByIndex(t)
                            , n = o.getName(i.node1.dataIndex)
                            , a = o.getName(i.node2.dataIndex)
                            , r = n + " > " + a;
        ...
        t.exports = i(2).extendChartView({
            ...
            , _renderOnGeo: function (t, e, i, a) {
                ...
                var p = Math.max(d.x, 0)
                    ...
                    , w = i.getExtent()
                    , b = "visualMap.continuous" === i.type ? o(w, i.option.range) : n(w, i.getPieceList(), i.option.selected);
        ...
        var o = i(1)
            , a = ["x", "y", "x2", "y2", "width", "height", "map", "roam", "roamDetail", "label", "itemStyle"]
            , r = {};
        t.exports = function (t) {
            var e = [];
                ...
                , render: function (t, e, i, r) {
                    ...
                    function u(e, i) {
                        ...
                        o(n, m, g, function (e, i) {
                            var n = r.childAt(h++);
                            e && !n ? l.push(a(e)) : e && s.updateProps(n, {
                                shape: {
                                    points: e
                                }
                            }, t)
        ...
        t.exports = i(2).extendChartView({
            ...
            , render: function (t, e, i) {
                ...
                d.diff(f).add(function (e) {
                    ...
                    c.add(e), l.setStyle(a.extend(s.getModel("lineStyle.normal").getLineStyle(), {
                        stroke: f
                    ...
                    u.eachChild(function (e) {
                        ...
                        }), o.setText(e.hoverStyle, w, f), e.hoverStyle.text = w.get("show") ? a.retrieve(t.getFormattedLabel(i, "emphasis", null, e.__dimIdx), n) : ""
        ...
        t.exports = i(2).extendChartView({
            ...
            , render: function (t, e, i) {
                ...
                var c = l.edgeData
                    , d = t.option
                    , f = a.createDataFormatModel(t, c, d.edges || d.links);
                f.formatTooltip = function (t) {
                    ...
                    }, n.getModel("itemStyle.normal").getItemStyle())), o.setHoverStyle(c, r.extend(e.getModel("itemStyle.emphasis"), {
        ...
        t.exports = i(2).extendChartView({
            ...
            , _renderNode: function (t, e, i, n, r, s, l, h, u) {
                function c(i, o, a) {
                    var r = null != y && e[i][y]
                        , s = n[i];
                    return r ? (e[i][y] = null, d(s, r, i)) : b || (r = new o({
                        z: a
                    }), f(s, r, i)), t[i][v] = r
                }
                ...
                function f(t, e, o) {
                    if ("background" === o) e.invisible = !0, e.__tmWillVisible = !0, s.push(e);
                    else {
                        var a = t[v] = {}
                            , r = l.parentNode;
                    ...
                    m(e.willDeleteEls, function (t, e) {
                        ...
                        m(t, function (t, n) {
                            var l = e.lastsForAnimation[i][n]
                                , h = {};
                            l && ("nodeGroup" === i ? l.old && (h.position = t.position.slice(), t.position = l.old) : (l.old && (h.shape = o.extend({}, t.shape), t.setShape(l.old)), l.fadein ? (t.setStyle("opacity", 0), h.style = {
                                opacity: 1
            ...
            , _onZoom: function (t, e, i) {
                if (this._mayClick = !1, "animating" !== this._state) {
                    ...
                    var o = n.getLayout();
                    if (!o) return;
                    var a = new u(o.x, o.y, o.width, o.height)
        ...
        for (var n = i(2), o = i(95), a = function () {}, r = ["treemapZoomToNode", "treemapRender", "treemapMove"], s = 0; s < r.length; s++) n.registerAction({
            type: r[s]
            , update: "updateView"
        }, a);
        n.registerAction({
            ...
            , _buildSplitLineAndArea: function (t) {
                ...
                if (r.length) {
                    ...
                    if ("circle" === s)
                        ...
                        for (var M = o.map(r, function (t, e) {
        ...
        t.exports = u.extend({
            ...
            , _renderAxisTick: function (t, e, i, n) {
                var o = n.getData()
                    , r = i.scale.getTicks()
                    , s = this._prepareTooltipHostModel(o, n);
                w(r, function (t, n) {
            ...
            , p = a.extend({
                ...
                , _renderEndsText: function (t, e, i) {
                    if (e) {
                        ...
                        var o = this.visualMapModel
                            ...
                            , h = this._applyTransform([s[0] / 2, 0 === i ? -a : s[1] + a], l)
                ...
                , _createHandle: function (t, e, i, a, l) {
                    var h = new r.Group({
                        ...
                        , u = n(o(e, a), s.bind(this._modifyHandle, this, e), "move");
                    h.add(u);
                    var c = {
                ...
                , _updateView: function (t) {
                    var e = this.visualMapModel
                        , i = e.getExtent()
                        , n = this._shapes
                        , o = this._dataInterval
                        , a = [0, e.itemSize[1]]
                        , r = t ? a : this._handleEnds
                        , s = this._createBarVisual(o, i, r, "inRange")
                ...
                , _createBarVisual: function (t, e, i, n) {
                    var o = this.getControllerVisual(t, n, "color").color
                        , a = [this.getControllerVisual(t[0], n, "symbolSize").symbolSize, this.getControllerVisual(t[1], n, "symbolSize").symbolSize]
                        , r = this._createBarPoints(i, a);
                    return {
        ...
        for (var n = i(220), o = [126, 25], a = [[[0, 3.5], [7, 11.2], [15, 11.9], [30, 7], [42, .7], [52, .7], [56, 7.7], [59, .7], [64, .7], [64, 0], [5, 0], [0, 3.5]], [[13, 16.1], [19, 14.7], [16, 21.7], [11, 23.1], [13, 16.1]], [[12, 32.2], [14, 38.5], [15, 38.5], [13, 32.2], [12, 32.2]], [[16, 47.6], [12, 53.2], [13, 53.2], [18, 47.6], [16, 47.6]], [[6, 64.4], [8, 70], [9, 70], [8, 64.4], [6, 64.4]], [[23, 82.6], [29, 79.8], [30, 79.8], [25, 82.6], [23, 82.6]], [[37, 70.7], [43, 62.3], [44, 62.3], [39, 70.7], [37, 70.7]], [[48, 51.1], [51, 45.5], [53, 45.5], [50, 51.1], [48, 51.1]], [[51, 35], [51, 28.7], [53, 28.7], [53, 35], [51, 35]], [[52, 22.4], [55, 17.5], [56, 17.5], [53, 22.4], [52, 22.4]], [[58, 12.6], [62, 7], [63, 7], [60, 12.6], [58, 12.6]], [[0, 3.5], [0, 93.1], [64, 93.1], [64, 0], [63, 0], [63, 92.4], [1, 92.4], [1, 3.5], [0, 3.5]]], r = 0; r < a.length; r++)
